 ...
 * @property {{curveEndpoint: number, surfaceMerging: number, surfaceNormal: number, forwardDistance: number}} numericalTolerances - Minimum tolerances used by primitive-based simulation engines. Distance values are relative to the scene length scale, while `surfaceNormal` is an angle in radians. Zero selects only the engine-derived numerical tolerance.
