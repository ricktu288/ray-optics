 ...
 * megakernel WebGPU scene. Keeping this as plain data also provides a cache
...
export function createWebGpuExecutionPlan(description, parameterRanges) {
  ...
  return {
    ...
    // Unlike the staged engine, every interaction type is embedded in one
    // tracing module. A guard/topology change in any included DAG therefore
