 ...
 * @property {string} colorMode - The mode of rendering the color of rays (color mapping functions, etc, including the brightness behavior when `simulateColors` is false). This represents the intended behavior for the scene, but the hardware may or may not support it. Possible values are 'legacy', 'linear', 'colorizedIntensity'.
