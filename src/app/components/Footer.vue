...
<template>
  ...
  <div class="footer-right" id="footer-right">
    <a class="btn" href="https://phydemo.app/ray-optics/" target="_blank" id="home" :title="$t('main:pages.home')" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom">
    ...
    <a id="github" class="btn" href="https://github.com/ricktu288/ray-optics" target="_blank" :title="$t('main:pages.github')" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom">
