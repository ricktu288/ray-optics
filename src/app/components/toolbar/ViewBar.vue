    ...
    <div class="row">
      <div class="btn-group" role="group">
        <template v-for="mode in viewModes" :key="mode">
          ...
          <label :id="'mode_' + mode + '_label'" class="btn shadow-none btn-primary" :for="'mode_' + mode" data-bs-placement="bottom">
      ...
      <div id="mobile-dropdown-view" class="mobile-dropdown">
        <ul>
          <li v-for="mode in viewModes" :key="mode">
            ...
            <label :id="'mode_' + mode + '_mobile_label'" class="btn btn-primary dropdown-item" :for="'mode_' + mode + '_mobile'"></label>
          </li>
        </ul>
      </div>
    </div>
