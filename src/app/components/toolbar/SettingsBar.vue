...
<template>
  <div v-if="layout === 'desktop'" class="col-auto">
    ...
    <div v-html="$t('simulator:settings.title')" class="row justify-content-center title d-none d-xxl-flex"></div>
    <div class="row justify-content-center title d-flex d-xxl-none" v-html="$t('simulator:settings.more')"></div>
  </div>
  ...
  <div v-if="layout === 'mobile'" class="col p-1">
    <button type="button" class="btn shadow-none btn-secondary w-100" data-bs-toggle="dropdown" data-bs-display="static">
      ...
      <span class="d-none d-md-inline" v-html="$t('simulator:settings.more')"></span>
    </button>
...
/**
 * @module SettingsBar
 * @description The vue component for the setting section of the toolbar.
 */
