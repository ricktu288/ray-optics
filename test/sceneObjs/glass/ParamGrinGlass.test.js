...
describe('ParamGrinGlass', () => {
  ...
  it('creates with default parametric equations', () => {
    ...
    expect(result.type).toBe('ParamGrinGlass');
  ...
  it('moves parametric GRIN glass', () => {
    user.click(100, 100);
    user.move(50, 100);
