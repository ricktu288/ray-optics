...
locales["ja"] = {
  ...
  "appDesc": {
    "incomplete": false,
    "message": "2Dの幾何学的な光学場面を作成し、シミュレーションするための無料のオープンソースのウェブアプリケーションです。"
  },
  "homepage_desc": {
    "incomplete": false,
    "message": "2次元の幾何学的な光学シーンを双方向的にシミュレートすることができます。<br>完全無料、ウェブベース。ソースコードは <a href=\"https://github.com/ricktu288/ray-optics\">GitHubで利用可能です。</a>."
  },
  "launch_simulator": {
    "incomplete": false,
    "message": "シミュレーターを起動"
  ...
  "save_description": {
    "incomplete": false,
    "message": "<a href=\"https://phydemo.app/ray-optics/gallery/\" target=\"_blank\">ギャラリー</a>　に <a href=\"https://github.com/ricktu288/ray-optics/blob/master/CONTRIBUTING.md#contributing-items-to-the-gallery\" target=\"_blank\">新しいアイテムを投稿</a>して、 自分のファイルを共有できます。"
  },
  "open": {
    "incomplete": false,
    "message": "開く"
  ...
  "get_link_popover": {
    "incomplete": false,
    "message": "現在のシーンの直接 URL をコピーして、共有に利用できます(URL 短縮機能を使用)。."
  },
  "get_link_warning": {
    "incomplete": false,
  ...
  "mode_images_popover": {
    "incomplete": false,
    "message": "すべての画像の位置を表示します。 黄色の点は実像を示し、オレンジ色は虚像を示し、灰色 (この図には何もありません) は仮想オブジェクトを示します。 「レイ密度」が十分に高くない場合、一部のイメージは検出できないことに注意してください。<br>「カラーのシミュレート」がオンの場合、イメージはソース カラーで表示され、代わりにドット サイズによって区別されます。"
  },
