...
locales["es"] = {
  ...
  "homepage_desc": {
        "message": "Crear y simular escenas 2D de óptica geométrica de manera interactiva.<br>Totalmente gratuito y basado en web. El código fuente está <a href=\"https://github.com/ricktu288/ray-optics\">disponible en GitHub</a>."
  },
  "launch_simulator": {
  ...
  "symbolic_grin": {
        "message": "Unión simbólica de cuerpos"
  },
  "grin_refractive_index": {
        "message": "<ul><li>Sólo soporta funciones diferenciables.</li><li>El origen de n(x,y) está en las coordenadas absolutas y no se mueve con el objeto. Puede hacer doble click sobre un punto de control para inspeccionar sus coordenadas absolutas.</li><li>Para una simulación más precisa, vea \"Más opciones...\"</li></ul>"
  },
  ...
  "bolditalic": {
        "message": "Negrita cursiva"
  },
  "oblique": {
        "message": "Oblicua"
  },
  "boldoblique": {
        "message": "Negrita oblicua"
  },
  "fontalignment": {
        "message": "Alineamiento"
  },
  "left": {
        "message": "Izquierda"
  },
  ...
  "mode_images_popover": {
        "message": "Mostrar la posición de todas las imágenes. Los puntos amarillos indican imágenes reales, naranjas indican imágenes virtuales, y grises (ninguno en esta figura) indican objetos virtuales. Cabe notar que algunas imágenes no se pueden detectar si 'Densidad de rayos' no es suficientemente elevada. <br>Cuando 'Simular colores' está seleccionado estos se muestran en los colores de la fuente y se distinguen por el tamaño del punto."
  },
