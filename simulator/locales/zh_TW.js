...
locales["zh-TW"] = {
  ...
  "tool_halfplane_popover": {
    "message": "模擬光線經過透光物體界面時的反射與折射。（拖曳或點擊以創建。）<br>若重疊多個透光物，重疊部分的等效折射率為個別之乘積。"
  },
  "tool_circlelens_popover": {
    "message": "圓形透光物，由圓心與表面上一點決定。（拖曳或點擊以創建。）<br>若重疊多個透光物，重疊部分的等效折射率為個別之乘積。"
  },
  "tool_refractor_popover": {
    "message": "任何由線段與圓弧組成的透光物。（點擊以建立線段，拖曳以建立弧形，點擊一開始的點以結束繪製。）<br>若重疊多個透光物，重疊部分的等效折射率為個別之乘積。"
  },
  "tool_lens_popover": {
    "message": "完全符合薄透鏡公式(1/p + 1/q = 1/f)的理想化透鏡，可直接設定其焦距(單位為像素)。（曳或點擊以創建。）"
  },
  "tool_sphericallens_popover": {
    "message": "球面透鏡。（點擊以創建。）<br>若重疊多個透光物，重疊部分的等效折射率為個別之乘積。"
  },
  ...
  "help_popover": {
    "message": "切換是否顯示提示泡泡。<br><br>其他功能：<br>點擊以選取物件，<br>Ctrl+D 以複製物件<br>刪除鍵以刪除物件，<br>方向鍵以緩慢移動物件，<br>滑鼠雙擊或右鍵點控制點以直接編輯座標。<br>當建立線段物件時，<br>按住 Shift 以鎖定角度，<br>按住 Ctrl 可以把第一個點當作是中點。<br>按住 Ctrl，點擊數個控制點，並點擊空白處以建立群組與控制柄。<br>拖曳控制柄時，<br>按住 Ctrl 以旋轉群組，<br>按住 Ctrl 與 Shift 以縮放群組。"
  }
}
