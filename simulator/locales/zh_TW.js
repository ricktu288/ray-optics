...
locales["zh-TW"] = {
  ...
  "color_mode_popover": {
    "message": "模擬光源的顏色（波長）、混色與透光物的色散。選取物件後可調整這些參數。重疊多條不同波長的光線可用於模擬光譜。<br><b>⚠️ 警告：<br><ul><li>像的顏色有時非常不準確（尤其當光線密度高的時候）。</li><li>此處之「波長」只用於模擬顏色與色散，無法模擬波動光學效應。</li><li>「匯出」鈕目前不支援混色。</b>"
  },
  "rayDensity_popover": {
