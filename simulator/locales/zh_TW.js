...
locales["zh-TW"] = {
  ...
  "color_mode_popover": {
    "message": "<img src='../img/simulate_colors.png' align='left' style='margin-right: 10px; margin-bottom: 4px; max-width: 250px'>模擬光源的顏色（波長）、混色與透光物的色散。選取物件後可調整這些參數。重疊多條不同波長的光線可用於模擬光譜。注意「光線密度」高時像的顏色有時不準確。「匯出」鈕目前不支援混色。"
  },
  "rayDensity_popover": {
