...
locales["ko"] = {
  ...
  "appDesc": {
    "incomplete": false,
    "message": "2D 기하 광학 생성 및 시뮬레이션을 위한 무료 오픈소스 웹 기반 앱입니다."
  },
  "homepage_desc": {
    "incomplete": false,
  ...
  "save_description": {
    "incomplete": false,
    "message": "작업을 공유하려면 <a href=\"https://phydemo.app/ray-optics/gallery/\" target=\"_blank\">갤러리</a>에 <a href=\"https://github.com/ricktu288/ray-optics/blob/master/CONTRIBUTING.md#contributing-items-to-the-gallery\" target=\"_blank\">'새 항목'</a>을 입력하십시오."
  },
  "open": {
    "incomplete": false,
    "message": "열기"
  ...
  "get_link_popover": {
    "incomplete": false,
    "message": "현재 장면 공유를 위한 URL 복사 및 이동 (URL 단축 기능 사용)."
  },
  "get_link_warning": {
    "incomplete": false,
  ...
  "mode_images_popover": {
    "incomplete": false,
    "message": "모든 상의 위치를 표시합니다. 노란색 점은 실상, 주황색 점은 허상, 회색 (예시 그림에는 없음) 점은 가상 객체를 나타냅니다. '광선 밀도'가 충분히 높지 않으면 일부 이미지를 감지할 수 없습니다.<br>'색상 (파장) 시뮬레이션'이 켜져 있으면 원본 색상으로 표시되고 점 크기로 구분합니다."
  },
