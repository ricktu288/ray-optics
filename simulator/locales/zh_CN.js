...
locales["zh-CN"] = {
  ...
  "color_mode_popover": {
    "message": "模拟光源的颜色（波长）、混色与透光物的色散。选取物件后可调整这些参数。重叠多条不同波长的光线可用于模拟光谱。<br><b>⚠️ 警告：<br><ul><li>像的颜色有时非常不准确（尤其当光线密度高的时候）。</li><li>此处之「波长」只用于模拟颜色与色散，无法模拟波动光学效应。 </li><li>「导出」钮目前不支持混色。 </b>"
  },
  "rayDensity_popover": {
