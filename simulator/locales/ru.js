...
locales["ru"] = {
  ...
  "mode_images_popover": {
    "incomplete": true,
    "message": "Показывает все изображения. Желтые точки - реальные изображения, оранжевые - мнимые, серые - мнимые объекты. Заметьте, что если \"плотность лучей\" недостаточно велика, некоторые изображения не будут видны.<br>When 'Simulate Colors' is on, they are shown in source colors and distinguished by dot sizes instead."
  },
  ...
  "rayDensity_popover": {
    "incomplete": true,
    "message": "Обозначает, сколько лучей будут симулировны. The number is in log scale."
  },
  "showgrid_popover": {
