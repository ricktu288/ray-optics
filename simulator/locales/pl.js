...
locales["pl"] = {
  "appName": {
    "message": "Symulacja biegu promieni"
  },
  "appShortName": {
    "message": "Optyka geometryczna"
  },
  "appDesc": {
    "message": "Aplikacja internetowa open source umożliwiająca symulację odbicia i załamania światła."
  },
  "homepage_desc": {
    "message": "Twórz i symuluj interaktywnie sceny optyki geometrycznej 2D.<br>Całkowicie darmowa aplikacja webowa. Kod źródłowy jest <a href=\"https://github.com/ricktu288/ray-optics\">dostępny na GitHub</a>."
  },
  "launch_simulator": {
    "message": "Uruchom symulator"
  },
  "home": {
  ...
  "save_description": {
    "message": "Aby udostępnić swoją pracę, możesz <a href=\"https://github.com/ricktu288/ray-optics/blob/master/CONTRIBUTING.md#contributing-items-to-the-gallery\" target=\"_blank\">dodać nowy element</a> do <a href=\"https://phydemo.app/ray-optics/gallery/\" target=\"_blank\">Galerii</a>."
  },
  "open": {
    "message": "Otwórz"
  },
  ...
  "refractiveindex_note_popover": {
    "message": "Jeśli ten obiekt ma być symulowany z bezwzględnym współczynnikiem załamania światła n₁, ale jest umieszczony wewnątrz innego szkła o współczynniku załamania światła n₀, to należy tutaj ustawić współczynnik załamania światła na n₁/n₀. W bardziej skomplikowanych przypadkach, gdy kilka obiektów szklanych nakłada się na siebie, efektywny współczynnik odbicia tego obszaru jest równy iloczynowi współczynników odbicia poszczególnych szkieł."
  },
  "cauchycoeff": {
  ...
  "get_link_popover": {
    "message": "Skopiuj i przejdź do bezpośredniego adresu URL bieżącej sceny, którego można użyć do udostępniania (możliwe za pomocą narzędzia do skracania adresów URL)."
  },
  "get_link_warning": {
