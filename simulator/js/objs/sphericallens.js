...
objTypes['sphericallens'] = {
  ...
  createLens: function(obj) {
    var p1 = obj.p1 || graphs.midpoint_points(obj.path[0], obj.path[1]);
    var p2 = obj.p2 || graphs.midpoint_points(obj.path[3], obj.path[4]);
  ...
  getDR1R2: function(obj) {
    ...
    var cx = (p1.x+p2.x)*.5;
    var cy = (p1.y+p2.y)*.5;
    var d = graphs.length(obj.path[2], obj.path[5]);
