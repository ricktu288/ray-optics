...
objTypes['beamsplitter'] = {
  ...
  draw: function(obj, ctx, aboveLight) {
    ...
    ctx.stroke();
    ctx.strokeStyle = getMouseStyle(obj, (scene.colorModeRefactored && obj.wavelength && obj.isDichroic) ? wavelengthToColor(obj.wavelength || GREEN_WAVELENGTH, 1) : 'rgb(100,100,168)');
