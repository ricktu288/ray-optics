...
objTypes['text'] = {
  ...
  clicked: function(obj, mouse_nogrid, mouse, draggingPart) {
    ...
    if (rotatedMouseX >= -obj.tmp_left && rotatedMouseX <=  obj.tmp_right &&
      ...
      draggingPart.mouse0snapped = scene.gridRefactored ? graphs.point(Math.round(draggingPart.mouse0.x / scene.gridSizeRefactored) * scene.gridSizeRefactored, Math.round(draggingPart.mouse0.y / scene.gridSizeRefactored) * scene.gridSizeRefactored) : draggingPart.mouse0;
