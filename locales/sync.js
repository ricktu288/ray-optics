...
locale_name = ['en', 'zh-TW', 'zh-CN', 'ru', 'nl', 'fr', 'de', 'pl', 'ja', 'si', 'ko', 'es', 'pt-BR', 'LOCALE_ID'];
locale_files = ['en.js', 'zh_TW.js', 'zh_CN.js', 'ru.js', 'nl.js', 'fr.js', 'de.js', 'pl.js', 'ja.js', 'si.js', 'ko.js', 'es.js', 'pt_BR.js', 'template.js'];
fs = require('fs');
